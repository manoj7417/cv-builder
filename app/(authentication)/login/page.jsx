        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 h-screen">
              ...
              <form className="mt-8" onSubmit={handleSubmit(handleLogin)}>
                <div className="space-y-5">
                  ...
                  <div>
                    <button
                      type="submit"
                      className="inline-flex w-full items-center justify-center rounded-md bg-blue-900 px-3.5 py-2.5 font-semibold leading-7 text-white hover:bg-blue-800"
                    >
                      Get started
          ...
          <div className="h-full w-full relative">
            <Image
              ...
              priority
            />
            <div className="absolute top-20 left-36 my-5">
                <Link
                  href={"/"}
                  className="text-5xl font-bold leading-tight  sm:text-5xl text-center bg-gradient-to-r from-blue-900 via-green-200 to-indigo-600 inline-block text-transparent bg-clip-text"
                >
