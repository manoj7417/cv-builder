            ...
            <form onSubmit={handleSubmit(hadleResetPassword)} className="mt-8">
              <div className="space-y-5">
                ...
                <div>
                  <button
                    type="submit"
                    className="inline-flex w-full items-center justify-center rounded-md bg-[#f76918] px-3.5 py-2.5 font-semibold leading-7 text-white hover:bg-blue-700"
                  >
                    {isLoading ? (
                      <>
                        <TbLoader className="mr-1  animate-spin text-white" />{" "}
                        Reseting Password
                      </>
                    ) : (
                      <>
