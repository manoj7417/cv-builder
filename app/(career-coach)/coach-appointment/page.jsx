...
const CoachAppointmentPage = () => {
  ...
  const handleTimezoneChange = (selectedOption) => {
    setNewAppointment({ ...newAppointment, timezone: selectedOption.value });
  };

  const handleSubmitBooking = () => {
    const { title, start, end, timezone } = newAppointment;
    const startDate = new Date(start);
    const endDate = new Date(end);
    
    if (title && isValid(startDate) && isValid(endDate)) {
      setAppointments([...appointments, { title, start: startDate, end: endDate, timezone }]);
      setNewAppointment({ title: "", start: "", end: "", timezone: "America/New_York" });
              ...
              <div id="book_an_appointment_tab">
                ...
                <div id="timeZone">
                  <Select
                    ...
                    value={timezones.find(tz => tz.value === newAppointment.timezone)}
                  />
                </div>
