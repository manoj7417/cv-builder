...
const CoachAvailability = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto mt-18 lg:p-0 p-5 lg:h-full h-[750px] lg:overflow-hidden overflow-y-scroll'>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='flex lg:flex-row flex-col gap-5'>
          <div className='lg:w-[70%] w-full form_calendar rounded-md border-2 border-gray-200 p-5'>
            {daysOfWeek.map((day, dayIndex) => (
              <div
                ...
                style={{ minHeight: '55px', transition: 'min-height 0.3s ease, height 0.3s ease' }}
                >
          ...
          <div className='lg:w-[30%] w-full time_zone'>
            ...
            <DateOverrides timeSlot={timeSlot} getFilteredTimeSlots={getFilteredTimeSlots}/>
         </div>
          </div>
        </div>
