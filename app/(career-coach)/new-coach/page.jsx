    ...
    <div>
      ...
      <section className="hows_it_work py-20">
        ...
        <div className="flex flex-wrap justify-between items-stretch gap-5 max-w-7xl mx-auto">
          <div className="step1 text-center lg:w-[20%] w-full bg-gray-100 p-5 rounded-md">
          ...
          <div className="step2 text-center lg:w-[20%] w-full bg-gray-100 p-5 rounded-md">
          ...
          <div className="step3 text-center lg:w-[20%] w-full bg-gray-100 p-5 rounded-md">
          ...
          <div className="step4 text-center lg:w-[20%] w-full bg-gray-100 p-5 rounded-md">
      ...
      <div className="additional_services lg:p-10 p-5">
        <div className="max-w-7xl mx-auto ">
          ...
          <div className="w-full">
            <CoachServiceSlider data={additionalServices} slidesPerView={4}/>
          </div>
        </div>
      </div>
      <div className="how_it_work bg-gray-100 lg:p-10 p-5">
        <div className="flex max-w-7xl mx-auto lg:flex-row flex-col">
          <div className="lg:w-[30%] w-full py-5 px-2">
            <h2 className="text-3xl font-bold">How can Career Coaching help you? </h2>
            <p className="text-sm my-4">
            Career coaching can inspire your career path and improve your professional results. But what benefits can be observed as part of the bigger picture? The advantages of having constant guidance and the consistent presence of a Career Coach need to be realised. Get coached to unlock opportunities and improvements that can make the most significant difference in your career
            </p>
            <Button>See All Services</Button>
          </div>
          <div className="lg:w-[70%] w-full">
