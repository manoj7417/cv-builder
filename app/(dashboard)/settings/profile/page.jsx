...
function Profile() {
    ...
    return (
        <>
            ...
            <section className="bg-gradient-to-r p-10">
                <div className='px-5'>
                    <p className='font-bold text-3xl flex items-center text-blue-900'><FaRegUserCircle className='mr-2' />Profile</p>
                </div>
                        ...
                        <div className="flex  my-3">
                            <div className="w-1/3 flex  justify-start relative ">
                                ...
                                <div className='flex flex-col justify-center items-center h-36 w-36'>
                                    <div>
                                        <Button variant={'outline'} className='my-2' onClick={handleImageUpload}><CiImageOn className='mr-1' />Change</Button>
                                        <input
                                            type="file"
                                            accept="image/*"
                                            ref={fileUploadRef}
                            ...
                            <div className=' w-2/3 px-10 p-5 shadow-lg rounded-2xl'>
                                <form onSubmit={handleSubmit(userProfileHandler)}>
                                    <div className="w-full">
                                        ...
                                        <div >
                                            {isEditable ? (
                                                ...
                                                <p className="text-gray-500 flex items-center h-8">{userdata?.fullname ? userdata?.fullname : "-"}</p>
                                            )}
                                        </div>
                                    </div>
                                    <div className="my-3 items-center">
                                        ...
                                        <div className="w-full">
                                            <div >
                                                <p className="text-gray-500 h-8">{userdata?.email ? userdata?.email : ""}</p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="w-full">
                                            <div >
                                                {isEditable ? (
                                                    ...
                                                    <p className="text-gray-500 h-10">{userdata?.address ? userdata?.address : '-'}</p>
                                                )}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className='py-4 flex justify-between'>
                                        <div className="flex items-center justify-end">
                                            {isEditable ? (
                                                <div>
                                                    <Button variant={'outline'} type='button' className='mr-4' onClick={() => setIsEditable(false)}>Cancel</Button>
                                                    <Button
                                                        type="submit"
