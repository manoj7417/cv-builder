  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <button
        ...
        className={`fixed top-4 lg:hidden ${
          isSidebarOpen ? "left-52 p-1" : "left-4 p-2"
        } z-30  rounded-md bg-white shadow-md transition-all duration-300`}
        onClick={() => setIsSidebarOpen(!isSidebarOpen)}
      >
        {/* <svg
          className="w-6 h-6 text-[#0d3572]"
          fill="none"
          stroke="currentColor"
          viewBox="0 0 24 24"
        >
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-10 w-64 bg-[#0d3572] transform ${
      ...
      <div
        ...
        // }`}
        className="lg:ml-64 ml-0 lg:mt-0 mt-10"
      >
        {children}
      </div>
    </div>
