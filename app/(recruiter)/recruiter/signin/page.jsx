    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <div className="hidden lg:block relative w-1/2 bg-gray-900">
        ...
        <div className="absolute bottom-16 left-8 right-8 text-white">
          <h1 className="text-4xl font-bold mb-4">Welcome to Your<br />Recruitment Journey</h1>
          <p className="text-lg text-gray-200">Find the perfect candidates for your team.</p>
        </div>
      </div>
