        ...
        <div className="bg-white/95 backdrop-blur-sm p-3 sm:p-6 md:p-8 rounded-2xl shadow-xl border border-white/20">
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-3 sm:gap-6 mb-4 sm:mb-8">
            ...
            >
              ...
              <span className="text-xs sm:text-base font-medium group-hover:text-gray-900">Back to Website</span>
            </Link>
          </div>

          {/* Form Header */}
          <div className="text-center space-y-1 sm:space-y-2 mb-4 sm:mb-8">
            <h2 className="text-xl sm:text-3xl md:text-4xl font-bold text-gray-900">Create your account</h2>
            <p className="text-xs sm:text-base md:text-lg text-gray-600">Join our platform to find the best talent</p>
          </div>
          ...
          <form className="mt-6 sm:mt-8 space-y-6 sm:space-y-8" onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
              ...
              {/* Company Input */}
              <div className="space-y-1.5">
                <label htmlFor="company" className="block text-xs sm:text-sm font-semibold text-gray-700">
                  Company Name
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-2.5 sm:pl-3 flex items-center pointer-events-none">
              ...
              {/* Position Input */}
              <div className="space-y-1.5">
                <label htmlFor="position" className="block text-xs sm:text-sm font-semibold text-gray-700">
                  Position
                </label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-2.5 sm:pl-3 flex items-center pointer-events-none">
