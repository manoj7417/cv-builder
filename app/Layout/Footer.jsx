...
export default function Footer() {
  return (
    <>
      <footer className="w-full lg:p-20 p-5 bg-gradient-to-b from-[#E0F2FE] to-[#dcecff] text-black" style={{ backgroundImage: "url('/banner-bg.svg')", backgroundPosition: "center" }}>
