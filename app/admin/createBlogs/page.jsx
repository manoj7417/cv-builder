...
function CreateBlogs() {
  ...
  return (
    ...
    <div className="back_button flex justify-end pt-5 pr-5">
        <button className="bg-blue-950 text-white px-3 py-2 rounded-md" onClick={handleBackButton}><MdKeyboardArrowLeft className="text-2xl inline-flex animate-pulse mr-3" />Back</button>
      </div>
