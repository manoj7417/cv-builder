  ...
  return (
    <>
      ...
      <Dialog open={showDialog}>
        <DialogContent
          className="sm:max-w-[60dvw] w-96 sm:w-full rounded-xl"
        ...
        >
          ...
          <p className="text-center text-sm sm:text-lg md:px-12 sm:px-12 text-gray-500">
            Select and upload the pdf file of the resume or simply upload your
            resume pdf from google drive or saved files. You can also choose to
            start creating a resume without using an existing resume file
          </p>
      ...
      {isError ? (
        <div className="w-full h-[80dvh] flex flex-col items-center justify-center border p-10 sm:p-0">
          <p className="text-md text-center sm:text-xl">
            The resume feedback you are looking for can not be found or is with
            restricted access.
          </p>
        ...
        <section className="analyser_resume_section " suppressHydrationWarning>
          ...
          <div className="w-full mb-6 flex items-center justify-center">
            <div className="main_heading_section">
              ...
              <p className="text-lg text-gray-500 text-center">
                Get a better understanding of your resume and improve your
          ...
          {/* <button
            className="fixed flex items-center bottom-5 left-1/2 transform -translate-x-1/2 bg-[#f76918] text-white py-2 px-4 rounded-full shadow-lg"
