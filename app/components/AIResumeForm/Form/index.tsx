...
export const BaseForm = ({
  ...
  <section
    className={`flex flex-col gap-3 rounded-md bg-white p-4 shadow transition-opacity duration-200 ${className}`}
  >
    {children}
  </section>
);
    ...
    >
      <div className="flex items-center justify-between gap-2">
        <div className="flex grow items-center gap-2">
          ...
          <input
            type="text"
            className="block w-full border-b border-transparent text-base font-semibold tracking-wide text-gray-900 outline-none hover:border-gray-300 hover:shadow-sm focus:border-gray-300 focus:shadow-sm"
            value={heading}
