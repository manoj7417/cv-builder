      ...
      <div className="flex-row justify-between rounded-xl shadow-xl mx-8 bg-white p-5 mb-10">
        ...
        {feedback.length > 0 ? (
          <div className="text-start mb-5">
            <h2 className="items-center flex cursor-pointer pt-5 font-bold mb-3 font-sm underline text-[#f76918]">
              <GiMagicLamp className="text-[#f76918] h-10 w-10 me-3" />
              Ask Genie to improve your resume{" "}
            </h2>
            <h3 className="mb-3 flex items-center justify-between">
              Suggestion to improve your resume:
              <FaCrown className="text-yellow-400 ms-3 h-6 w-6" />
            </h3>
          ...
          <div className="text-center">
            {loading ? (
              ...
              <>
                <button
                  onClick={submitDataToAnalyze}
                  className="bg-[#f76918] hover:bg-indigo-700 text-white py-2 px-6 rounded mt-3"
                >
                  Analyze
                </button>
                <button className="bg-[#f76918] hover:bg-indigo-700 text-white py-2 px-6 rounded mt-3 ms-3">
                  Upload resume to analyze
                </button>
              </>
            )}
        ...
        <div>
          {feedback.length > 0 ? (
            ...
            <>
              <h2 className="text-gray-700 pt-5 text-center mb-3 font-sm">
                How it works
              </h2>
              <ol className="text-gray-600 text-sm list-decimal px-8 space-y-2 bg-blue-100 p-3">
                ...
                <li>
                  It will provide a score and suggestions on how to improve your
                  resume.
                </li>
              </ol>
            </>
