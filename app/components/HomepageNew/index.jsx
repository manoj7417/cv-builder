          ...
          <div className="flex flex-col xs:flex-row items-center max-w-6xl">
            <div className="text-start">
              <h1 className="text-3xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-extrabold mb-4 sm:mb-6 xs:text-start text-center">
                Super Charge Your <span className="text-blue-600">Career</span>{" "}
                Potential
              </h1>
              ...
              <div className="flex justify-center xs:justify-start">
                <button
                  ...
                  className="bg-blue-600 text-white py-3 px-8 rounded hover:bg-blue-950 transition duration-300"
                >
                  Get Started
                </button>
              </div>
