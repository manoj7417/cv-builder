      ...
      />
        <section className="bg-gradient-to-r from-white to-[#dcecff] text-gray-800 py-20">
          <div className="max-w-6xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl xl:text-4xl 2xl:text-4xl font-bold mb-6">Cookie Policy</h1>
            ...
            <section className="mb-8">
              <h2 className="text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl font-semibold mb-4">What Are Cookies?</h2>
              <p className="text-sm sm:text-lg md:text-lg lg:text-lg xl:text-lg 2xl:text-lg mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl font-semibold mb-4">Our Commitment</h2>
              <p className="text-sm sm:text-lg md:text-lg lg:text-lg xl:text-lg 2xl:text-lg mb-4">
                We explain in our{" "}
