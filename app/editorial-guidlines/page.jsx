    ...
    <>
      ...
      <section
        ...
        <div className='max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8'>
          ...
          <section className='mb-8'>
            <h3 className='text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl font-semibold mb-2'>
          ...
          <section className='mb-8'>
            <h4 className='text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl font-semibold mb-2'>
          ...
          <section className='mb-8'>
            <h5 className='text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl font-semibold mb-2'>
              Diverse Backgrounds
            </h5>
            <p className='text-sm sm:text-lg md:text-lg lg:text-lg xl:text-lg 2xl:text-lg'>
          ...
          <section className='mb-8'>
            <h6 className='text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl font-semibold mb-2'>
          ...
          <section className='mb-8'>
            <p className='text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl font-semibold mb-2'>
          ...
          <section className='mb-8'>
            <span className='text-xl sm:text-xl md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl font-semibold mb-2'>
