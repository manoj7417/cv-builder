            ...
            <div className="flex flex-col items-center lg:items-start">
              ...
              <div className="flex flex-col sm:flex-row gap-2 py-3 rounded-lg w-full">
                ...
                <div className="w-full flex items-center">
                  ...
                  <button
                    className="bg-[#f76918] text-white px-5 py-2 rounded-lg flex items-center gap-2 mx-auto text-sm"
            ...
            <div className="max-w-7xl mx-auto steps_intro lg:py-0 sm:p-5 p-5">
              ...
              <div className=" block sm:block md:block lg:hidden xl:hidden 2xl:hidden step_2 relative mt-20">
                ...
                <div className="flex lg:flex-row flex-col gap-10  lg:p-1 p-5">
                  ...
                  <div className="lg:w-[50%] w-full steps_content mt-10">
                    <p className="text-base py-3 text-[#1B1B1F]">
                      If you end up choosing the &quot;Start Afresh&quot;
                      option, there are little pointers that you need to provide
                      to our CV Match tool. While creating a{" "}
                      <b>professional CV</b> there are many things that need to
                      be taken into account such as Job Profile, Educational
                      Qualifications, Professional Experiences, Special Skills,
                      and so much more. You just need to briefly provide all the
                      details to the too by answering the short questionnaire.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex lg:flex-row flex-col gap-10 mt-20 lg:p-1 p-5">
                  ...
                  <div className="lg:w-[50%] w-full steps_content pt-20">
                    ...
                    <p className="text-base py-3">
                      ...
                      per your preference. For us at Genies Career Hub,
                      it&apos;s all about catering to your likes.
                    </p>
                  </div>
                </div>
