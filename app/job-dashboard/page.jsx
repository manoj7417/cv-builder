      ...
      <div className="bg-[#0d3572] text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-2 text-blue-100">
            Manage your job applications and explore opportunities
          </p>
        </div>
      </div>
            ...
            <nav className="flex space-x-8 px-6" aria-label="Tabs">
              ...
              >
                ...
                {appliedJobs.length > 0 && (
                  <span className="ml-2 bg-blue-100 text-[#f76918] px-2.5 py-0.5 rounded-full text-xs">
                    {appliedJobs.length}
                  </span>
                )}
              </button>
                      ...
                      <div className="flex justify-between items-center mb-6">
                        <div className="flex items-center gap-4">
                          ...
                          >
                            <svg
                              className={`w-5 h-5 ${
                                appliedJobsLoading ? "animate-spin" : ""
                              }`}
                              fill="none"
                              viewBox="0 0 24 24"
                              stroke="currentColor"
      ...
      <div className="flex justify-between items-start">
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3">
            <span className="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-blue-100 text-[#f76918]">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-4">
        <div className="space-y-4 flex-1">
          ...
          <div className="text-sm text-gray-500 flex items-center">
            <CalendarIcon className="w-4 h-4 mr-1.5" />
            Applied on{" "}
            {new Date(applicationDetails.appliedAt).toLocaleDateString(
              "en-US",
              {
                year: "numeric",
                month: "long",
    ...
    <div className="mx-auto">
      <div className="bg-white rounded-lg border border-gray-200 p-8">
        ...
        <div className="flex flex-wrap gap-4 mt-6">
          <span className="inline-flex items-center px-4 py-2 rounded-full text-sm font-medium bg-blue-100 text-[#f76918]">
