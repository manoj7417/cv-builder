        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "BreadcrumbList",
              itemListElement: [
                { "@type": "ListItem", position: 1, name: "CV Template", item: "https://www.geniescareerhub.com/resume" },
                { "@type": "ListItem", position: 2, name: "Resume Formatting", item: "https://www.geniescareerhub.com/resume-analyzer" },
                { "@type": "ListItem", position: 3, name: "CV Creators", item: "https://www.geniescareerhub.com/job-cv" },
              ],
            }),
          }}
        />
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              step: [
                { "@type": "HowToStep", text: "Open the Curriculum Vitae Builder and check out the variety of CV template options.", image: "https://www.geniescareerhub.com/resume21.png" },
                { "@type": "HowToStep", text: "Select the best curriculum vitae format and start creating your CV with the help of AI.", image: "https://www.geniescareerhub.com/resume22.png" },
                { "@type": "HowToStep", text: "Mention all the essential information in CV format and finalize the content of the CV with AI." },
                { "@type": "HowToStep", text: "Review your finalized CV created using the CV Builder." },
                { "@type": "HowToStep", text: "Download the created CV in PDF format." },
              ],
            }),
          }}
        />
