...
export default function DashboardIdea() {
  ...
  const handlepdfFileChange = async (e) => {
    ...
    if (!validTypes.includes(selectedFile?.type)) {
      return toast.error("Please select a valid PDF or DOCX file");
    }
    ...
    const processFile = async (file) => {
      if (file.type === "application/pdf") {
        ...
        // Process DOCX file
        return await docxToText(file); // Implement `docxToText` function
      }
      return null;
    };
          ...
          <div className="flex flex-col max-w-8xl text-center px-8  lg:px-32 pt-16 sm:pt-28">
            <div className=" flex flex-col">
              ...
              <p className="text-gray-700 text-sm lg:text-md sm:text-lg lg:px-32">
                ...
                selection? Analyse your CV for ATS compatibility with our
                AI-based ATS Resume Checker. Get industry expertise integrated
                to create an Application Tracking system-friendly resume and
                flawless application profile that gets passed through the ATS CV
                checker.
              </p>
