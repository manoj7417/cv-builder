...
Crafted by seasoned professionals in the industry, our portfolio builder is meticulously designed to cater to a diverse range of needs and requirements, ensuring that every aspect of your portfolio is addressed with expertise and precision.</p>
              <div className="flex items-center space-x-4">
                <button className="text-xl text-white bg-blue-500 rounded-xl px-5 mt-5 py-3" ><a href="/resume-import">Build Resume for free</a></button>
              </div>
            </div>
            <Image src="/ats friendly.png" className="px-7 pt-7 rounded-t-3xl " alt="@shadcn" width={600} height={100} />
          </div>
        </div>
      <div className="w-full  bg-white" >
        <div className="rounded-t-3xl border-t-8 border-blue-500 p-6 shadow-xl ">
            <h2 className="text-3xl text-center font-semibold my-5">Templates available for you to choose from</h2>
          <Tabs className="w-full py-5" defaultValue="all">
            <TabsList className="mb-4 flex w-full justify-center">
              <TabsTrigger value="all"><FaBorderAll className="text-pink-600 h-8 w-8 me-3" />All templates</TabsTrigger>
              <TabsTrigger value="simple"><PiFolderSimpleUser className="text-blue-700 h-8 w-8 me-3" />Simple</TabsTrigger>
              <TabsTrigger value="ats"><MdQueryStats className="text-orange-600 h-8 w-8 me-3"/>Ats</TabsTrigger>
              <TabsTrigger value="designer"><IoShirt className="text-green-700 h-8 w-8 me-3"/>Designer</TabsTrigger>
              <TabsTrigger value="professional"><RiShirtFill  className="text-red-700 h-8 w-8 me-3"/>Professional</TabsTrigger>
            </TabsList>
