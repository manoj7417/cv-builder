      ...
      <section className="bg-gradient-to-r from-white to-[#dcecff] text-gray-800 py-20">
        <div className="max-w-6xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
          ...
          <section className="mb-8">
            <h2 className="text-2xl sm:text-2xl  md:text-2xl lg:text-2xl xl:text-2xl 2xl:text-2xl  mb-2 font-bold">Return to Work:</h2>
          ...
          <section className="mb-8">
            ...
            <p className="text-sm sm:text-lg md:text-lg lg:text-lg xl:text-lg 2xl:text-lg">We are fair-minded and flexible.</p>
          </section>
          <section className="mb-8">
          ...
          <section className="mb-8">
            ...
            <p className="text-sm sm:text-lg md:text-lg lg:text-lg xl:text-lg 2xl:text-lg">Your order can be canceled at any time.</p>
            <p className="text-sm sm:text-lg md:text-lg lg:text-lg xl:text-lg 2xl:text-lg">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-5 space-y-2">
              ...
              <li className="text-sm sm:text-lg md:text-lg lg:text-lg xl:text-lg 2xl:text-lg">Any particular data that was erased.</li>
              <li className="text-sm sm:text-lg md:text-lg lg:text-lg xl:text-lg 2xl:text-lg">
