  ...
  myMiddlewares((set) => ({
    ...
    deleteResume: (resumeId) =>
      set((state) => ({
        userState: {
          ...state.userState,
          resumes: state?.userState?.resumes.filter(
    ...
    getResumeById: (resumeId) => {
      ...
      return state?.userState?.resumes?.find(
        (resume) => resume?._id === resumeId
      );
    },
    updateResumeContentById: (resumeId, newData) =>
      set((state) => ({
        userState: {
          ...state.userState,
          resumes: state?.userState?.resumes?.map((resume) =>
    ...
    updateRedirectPricingRoute: (route) =>
      set((state) => ({
        userState: {
          ...state.userState,
