      ...
      <div className="text-gray-800 my-20">
        <div className="container mx-auto p-6 bg-white shadow-lg rounded-lg">
          ...
          <p className="mt-4">
            ...
            use of <strong>Career Genies Hub</strong>'s Website, located at{" "}
          ...
          <p>
            ...
            agreement with the <strong>Career Genies Hub</strong>'s Privacy
            Policy.
          </p>
          <p className="mt-4">
          ...
          <p className="mt-4">
            No use of <strong>Career Genies Hub</strong>'s logo or other artwork
