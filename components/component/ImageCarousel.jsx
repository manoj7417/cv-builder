    ...
    <CarouselItem>
      <div className="grid grid-cols-1 sm:grid-cols-5 gap-6 p-4 pt-14">
        {data.map((image, index) => {
          return (
            <div
              className="group relative 2xl:h-[375px] md:h-[210px] h-[280px] 2xl:w-[275px] md:w-[170px] w-[200px] overflow-hidden rounded-lg shadow-lg 2xl:p-4 p-2 bg-gradient-to-t from-[#8181b9] to-[#dcecff]"
              key={index}
            >
