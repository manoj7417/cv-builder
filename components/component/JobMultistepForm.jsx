...
function JobMultistepForm({
  ...
  const handleExperienceCheckChange = (index) => {
    const updatedFormData = {
      ...formData,
      experience: formData.experience.map((exp, expIndex) => {
        if (expIndex === index) {
          return {
            ...exp,
            present: !exp.present,
            endDate: !exp.present ? "present" : "",
          };
        }
        return exp;
      }),
  ...
  const handleEducationCheckChange = (index) => {
    const updatedFormData = {
      ...formData,
      education: formData.education.map((edu, eduIndex) => {
        if (eduIndex === index) {
          return {
            ...edu,
            present: !edu.present,
            endDate: !edu.present ? "present" : "",
          };
        }
        return edu;
      }),
  ...
  const handleProjectCheckChange = (i) => {
    const updatedFormData = {
      ...formData,
      projects: formData.projects.map((pro, proIndex) => {
        if (proIndex === i) {
          return {
            ...pro,
            present: !pro.present,
            endDate: !pro.present ? "present" : "",
          };
        }
        return pro;
      }),
            ...
            <div className=" shadow-xl px-4 sm:px-10 py-5 w-full h-full max-h-full rounded-2xl overflow-hidden  bg-white">
              <div className="flex items-center">
                <Checkbox
                  ...
                  id="checkbox"
                />
                <Label htmlFor="checkbox" className="text-md sm:text-lg ml-4">
                  Are you a fresher?
                </Label>
              </div>
                                      ...
                                      <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 px-2">
                                        ...
                                        <div className="flex flex-col w-full md:w-1/2 space-y-1 pl-2">
                                          ...
                                          <DatePicker
                                            ...
                                            className="w-full h-10"
                                            disabledDate={(e) =>
                                              disabledExperienceEndDate(e, item)
                                            }
                                            maxDate={dayjs()}
                                    ...
                                    <div className="flex flex-col w-full md:w-1/2 space-y-1 justify-around lg:pl-2 pl-0">
                                      ...
                                      <div className="w-full">
                                        {item?.present ? (
                                          ...
                                          <DatePicker
                                            ...
                                            className="w-full h-10"
                                            disabledDate={(e) =>
                                              disableEducationEndDate(e, item)
                                            }
                                            maxDate={dayjs()}
                                            disabled={!item?.startDate}
                                          />
                                      ...
                                      <div className="flex items-center">
                                        <Checkbox
                                          ...
                                          onCheckedChange={() =>
                                            handleEducationCheckChange(index)
                                          }
                                        />
                                    ...
                                    <div className="flex flex-col w-full space-y-2 justify-around lg:pl-2 pl-0">
                                      ...
                                      <div className="flex items-center">
                                        <Checkbox
                                          ...
                                          checked={item?.present}
                                          onCheckedChange={() =>
                                            handleProjectCheckChange(index)
                                          }
                                        />
  ...
  if (steps === 6) {
    return (
      <DialogContent
        className="sm:max-w-[70dvw] no-scrollbar h-[80vh]"
        onClick={handleCloseMultistepForm}
        showCloseButton
      >
