  ...
  return (
    <div>
      <Tabs className="w-full py-5">
        ...
        <TabsContent value="Profile" className="mb-4">
        ...
        <TabsContent className="mb-6" value="Analyser">
              ...
              <div className="flex flex-wrap">
                {loading ? (
                  Array(5)
                    ...
                    .map((_, index) => (
                      <div
                        className="lg:w-[350px] w-full  my-4 flex-1"
                        key={index}
                      >
        ...
        <TabsContent className="mb-6" value="Psychometric">
