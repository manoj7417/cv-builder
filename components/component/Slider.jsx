...
import { MdOutlineDesignServices, MdOutlineSettingsSuggest } from "react-icons/md"
...
<div className="container mx-auto mb-10 ">
  <h2 className="mb-8 text-3xl font-semibold tracking-tight text-center md:text-4xl">Expertly Crafted Resume Templates - Choose and Customize</h2> 
  <p className="text-center max-w-3xl mx-auto">We offer a selection of professionally designed resume and cover letter templates to assist you in crafting a polished and effective application. Our intuitive resume builder allows you to easily create a tailored resume to suit your unique needs.</p>
  ...
  <div className="flex justify-center gap-8 mt-20">
    ...
    <FaUserCog className="h-14 w-14 bg-indigo-500 rounded-full text-white p-2 " />
      ...
      <p className="text-base mt-2 text-center">Templates crafted by domain experts.</p>
    </div>
    <div className="flex flex-col items-center flex-1 p-5 rounded-2xl">
      <MdOutlineDesignServices className="h-14 w-14 bg-indigo-500 rounded-full text-white p-2" />
      <p className="text-base mt-2 text-center">Customize layouts to suit your preferences.</p>
    </div>
    <div className="flex flex-col items-center flex-1 p-5 rounded-2xl">
      <MdOutlineSettingsSuggest className="h-14 w-14 bg-indigo-500 rounded-full text-white p-2" />
      <p className="text-base mt-2 text-center">Receive personalized suggestions for improvement.</p>
    </div>
  </div>
</div>
