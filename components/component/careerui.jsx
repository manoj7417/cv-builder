...
* @see https://v0.dev/t/ZZ33PIpwwcG
  ...
  return (
    <div className="flex min-h-screen w-full bg-background">
          ...
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger asChild>
                <Link
                  href="#"
                  className="flex h-9 w-9 items-center justify-center rounded-lg bg-primary text-lg font-semibold text-primary-foreground transition-colors hover:bg-primary/90 md:h-8 md:w-8 md:text-base"
                  prefetch={false}
                >
      ...
      <div className="flex flex-col sm:gap-4 sm:py-4 sm:pl-14">
        ...
        <main className="flex flex-1 items-start gap-4 p-4 sm:px-6 sm:py-0 md:gap-8 lg:grid lg:grid-cols-3 xl:grid-cols-3">
