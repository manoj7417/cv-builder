  ...
  if (steps === 1) {
    return (
      <DialogContent className="sm:max-w-[425px]">
        ...
        <DialogFooter>
          <Button onClick={() => setSteps(prev => prev + 1)} disabled={formData?.jobTitle.length == 0}>Next</Button>
        </DialogFooter>
      </DialogContent>
    )
  } else if (steps === 2) {
    return (
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Enter relevant work experience related to the job which you want to apply for.
          </DialogDescription>
        </DialogHeader>
        <div className="grid grid-cols-2 gap-5">
          <div className="w-full">
            <Label htmlFor="name" className="text-right">
              Job Title <span className=" text-10px italic ml-1 text-gray-500">(optional)</span>
            </Label>
            <Input
              name="jobTitle"
              placeholder="Enter your job title"
          ...
          <div className="w-full">
            <Label htmlFor="employer" className="text-right">
              Comapny<span className=" text-10px italic ml-1 text-gray-500">(optional)</span>
            </Label>
            <Input
              name="companyName"
        ...
        <div>
          <div className="grid grid-cols-2 gap-5">
            <div>
              <Label htmlFor="employer" className="text-right">
                Start Date<span className=" text-10px italic ml-1 text-gray-500">(optional)</span>
              </Label>
              <DatePicker placeholder="Start Date" name="startDate" />
            </div>
            <div>
              <Label htmlFor="employer" className="text-right">
                End Date<span className=" text-10px italic ml-1 text-gray-500">(optional)</span>
              </Label>
        ...
        <div>
          <Label htmlFor="employer" className="text-right">
            Job Description<span className=" text-10px italic ml-1 text-gray-500">(optional)</span>
          </Label>
    ...
    return (
      <DialogContent className="sm:max-w-[425px]">
        ...
        <div >
          <Textarea placeholder="Enter relevant skills " value={formData.skills} onChange={handleskillsChange} />
        </div>
        <DialogFooter>
