    ...
    <div>
      {data?.visible && (
        <div className='profile_section w-full'>
          ...
          <div
            className={`my-10 p-5 ${fontStyle.subHeadingFont} break-normal`}
                      ...
                      <div className='references w-full'>
                        {isValidUrl(item?.url) ? (
                          <a
                            href={item?.url}
                            target='_blank'
                            className='break-normal text-16px items-center text-white inline-flex'>
                            {item?.name}
                            <AiOutlineLink className='ml-1' />
                          </a>
                        ) : (
                          <p className='break-normal text-15px text-white'>
                            {item.name}
                          </p>
                        )}
                        <h3
                    ...
                    <div
                      ...
                      {basics?.email && (
                        <a
                          ...
                          <p className='flex flex-wrap break-normal'>
                            {basics?.email}
                          </p>
                        </a>
                      )}
