                      ...
                      <ul className='list-disc pl-2'>
                        {item?.highlights?.map((item, key) => {
                          return (
                            <li
                              key={key}
                              className='py-2 break-normal text-15px'>
                              {item}
                            </li>
                          );
                        })}
    ...
    <div>
      {data?.visible && (
        <div className='profile_section'>
          ...
          <div
            className={`my-5 break-normal ${fontStyle.subHeadingFont}`}
    ...
    <>
      <div className='resume_wrapper flex bg-white  mx-auto w-full min-h-screen'>
        <div
          ...
          <h1
            className={`${fontStyle.mainHeadingFont} uppercase font-bold break-normal py-5 px-8`}>
            {basics?.name}
          </h1>
        ...
        <div className='resume_right w-[65%] px-10 py-5 text-[#26252d]'>
          <div className='resume_item resume_namerole'>
            <p
              className={`${fontStyle.jobtitleFont} break-normal uppercase font-bold`}
              style={{
