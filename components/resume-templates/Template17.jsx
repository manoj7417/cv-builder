              ...
              <div>
                <ul className=''>
                  {data?.items?.map((item, index) => {
                    return (
                      <div
                        className='certificate_section px-2 py-4'
                        key={index}>
                        {isValidUrl(item?.url) ? (
                          <a
                            href={item?.url}
                          ...
                          <p className='break-normal text-xl font-bold text-white'>
                            {item.name}
                          </p>
                        )}
                        <div
                          className={`py-2 ${fontStyle.paraFont} break-normal text-white`}
                          dangerouslySetInnerHTML={{
                            __html: item?.description,
                          }}></div>
                      </div>
            ...
            <div className='w-full flex flex-col items-start justify-start mt-6 gap-6'>
              ...
              <div className='w-full grid grid-cols-12'>
                <div
                  ...
                  style={{ backgroundColor: metadata?.theme?.primary }}></div>
                <div className='col-span-9'>
                  ...
                  {basics?.phone && (
                    <a
                      ...
                      <p className='w-[80%] text-wrap break-normal text-white'>
                        {basics?.phone}
                      </p>
                    </a>
                  )}
