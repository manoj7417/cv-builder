      ...
      <div className="bg-white mx-auto">
        <div className="top_section flex justify-around items-center bg-gray-200 py-10">
          <div className="name_profile">
            <h1 style={{ fontSize: fontStyle.mainHeadingFont,padding:fontStyle.paddingFont }} className="text-4xl uppercase font-bold">
              {resumeData?.basics?.name}
            </h1>
            <p style={{ fontSize: fontStyle.headingFont }} className="text-base font-medium mt-1">
        ...
        <div className="resume_section mt-5 flex flex-row">
          <div className="md:w-[30%] w-full left_side border-r-2 border-gray-300 p-5">
            <div className="contact_section border-b-2 border-gray-300 pb-3">
              <h2 style={{ fontSize: fontStyle.headingFont }} className="text-xl text-gray-600 font-semibold uppercase">
                Contact
              </h2>
            ...
            <div className="skills_section border-b-2 border-gray-300 py-3">
              ...
              <div className="text-gray-600 my-5">
                <ul className="list-disc pl-5">
                  <li style={{ fontSize: fontStyle.paraFont }} className="font-bold text-gray-600">React js</li>
                  <li style={{ fontSize: fontStyle.paraFont }} className="font-bold text-gray-600">Next js</li>
                  <li style={{ fontSize: fontStyle.paraFont }} className="font-bold text-gray-600">Node js</li>
                  <li style={{ fontSize: fontStyle.paraFont }} className="font-bold text-gray-600">Tailwind Css</li>
                  <li style={{ fontSize: fontStyle.paraFont }} className="font-bold text-gray-600">Redux</li>
                  <li style={{ fontSize: fontStyle.paraFont }} className="font-bold text-gray-600">Redux Toolkit</li>
                  <li style={{ fontSize: fontStyle.paraFont }} className="font-bold text-gray-600">React Query</li>
                </ul>
              </div>
            </div>
            <div className="education_section py-3">
              ...
              <div className="text-gray-800 my-5">
                <div className="education1 my-5">
                  <h3 style={{ fontSize: fontStyle.subHeadingFont }} className="font-bold">Post Graduation</h3>
                  <h4 style={{ fontSize: fontStyle.paraFont }}>Technical University Dehradun</h4>
                  <p style={{ fontSize: fontStyle.paraFont }}>2014-2015</p>
                </div>
                <div className="education1">
                  <h3 style={{ fontSize: fontStyle.subHeadingFont }} className="font-bold">Bachelor of Technology</h3>
                  <h4 style={{ fontSize: fontStyle.paraFont }}>Technical University Dehradun</h4>
                  <p style={{ fontSize: fontStyle.paraFont }}>2014-2015</p>
                </div>
                <div className="education1 my-5">
          ...
          <div className="md:w-[70%] w-full right_side p-5">
            <div className="about_section">
              <div className="about_heading flex gap-5 items-center">
                ...
                <h2 style={{ fontSize: fontStyle.headingFont }} className="text-xl font-bold uppercase">About Us</h2>
              </div>
              <p style={{ fontSize: fontStyle.paraFont }} className="my-5">
              ...
              <div className="experience_1 my-5">
                <div className="post flex  justify-between items-center my-2">
                  <div className="post_title">
                    <h3 style={{ fontSize: fontStyle.subHeadingFont }} className="font-bold">Senior Graphic Designer</h3>
                    <h4 style={{ fontSize: fontStyle.paraFont }} className="font-semibold">Test Company</h4>
                  </div>
                  <div className="year font-bold">
                    <p style={{ fontSize: fontStyle.paraFont }}>2010-2014</p>
                  </div>
                </div>
                <div className="key_points">
                  <p style={{ fontSize: fontStyle.paraFont }} className="my-2">
                    Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                    Dolorem ipsum culpa rem voluptatem non laudantium, quae
            ...
            <div className="project_section my-2">
              <div className="project_heading flex gap-5 items-center">
                ...
                <h2 style={{ fontSize: fontStyle.headingFont }} className="text-xl font-bold uppercase">Projects</h2>
              </div>
