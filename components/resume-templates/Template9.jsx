            ...
            {data?.items?.map((item, index) => {
              return (
                <>
                  ...
                  <div
                    className={`py-2 ${fontStyle.paraFont} break-normal text-justify`}
      ...
      {data?.visible && data?.items?.length > 0 && (
        <>
          <div className='awards_header w-full'>
            <h2
              className={`${fontStyle.headingFont} font-bold uppercase underline underline-offset-4`}
              style={{
                color: headingColor,
              }}>
              {data?.name}
                ...
                <>
                  <div className='references my-5' key={index}>
                    <div className='references_names w-full my-1'>
                      ...
                      <div className='references w-full break-normal'>
                        <h4 style={{ fontSize: fontStyle.paraFont }}>
                          {item?.email}
                        </h4>
                        <h4 style={{ fontSize: fontStyle.paraFont }}>
      ...
      <div className='template_8 w-full min-h-screen'>
        ...
        >
          <div className='top_section flex items-start gap-1 justify-start px-10 bg-[#E0FBE2]'>
            <div className='name_profile w-full mt-2'>
              <h1
